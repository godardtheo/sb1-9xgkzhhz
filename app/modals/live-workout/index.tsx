...
import { ArrowLeft, Edit2, Trash2, Plus, Timer, X } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      {isRestTimerActive && (
        ...
        >
          ...
          <Text style={styles.restTimerText}>{formatTime(activeRestTime)}</Text>
          <Pressable
